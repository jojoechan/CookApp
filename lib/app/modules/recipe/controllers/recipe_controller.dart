...
class RecipeController extends GetxController {
  ...
  void getRecipeData(String id) {
    ...
    recipe.value = RecipeData.fromJson({
      ...
      "description":
          "A Japanese-style ramen that used Miso as its based and Chasu as toppings, dressed with fresh spring onions. Perfectly balanced between light-yet-bold soup and the smokey taste of Chasu that has been soaked with mirin to make a simple ramen become so rich with flavour.",
      "userID": "291071012238",
      "user": "User Tetsu",
      "userImage": "",
      "ingredients":
